...
<head>
    ...
    <title>Kelas Kolaborasi Universitas Tanjungpura</title>
</head>
<body>
  <div class="navbar-fixed">
      <nav class="pink darken-1">
        <div class="nav-wrapper">
          <div class="container">
            <a href="index.php" class="brand-logo"><img src="img/kelas kolaborasi.png"> <span>Kelas Kolaborasi</span></a>
  ...
  <ul class="sidenav" id="mobile-nav">
    ...
    <li><a href="views/about.php">Tentang Kami</a></li>
    <li><a href="views/artikel.php">Article</a></li>
    <li><a href="views/contact.php">Kontak kami</a></li>
  </ul>
  <!-- akhir nav-mobile -->
  ...
  <footer>
    <p class="center">&copy;Copyrigt By Kelas Kolaborasi Untan</p>
  </footer>
